...
<p>All Base Rent and other sums payable by Tenant under this Lease (collectively, &ldquo;Rent&rdquo;) shall be paid in lawful United States currency by check, ACH transfer, wire transfer, or such other method as Landlord may designate in writing from time to time. Rent shall be paid to Landlord at the address set forth in this Lease, or to such other person or at such other address as Landlord may designate by written notice to Tenant.</p>
