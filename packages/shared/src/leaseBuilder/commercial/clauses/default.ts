...
<ol>
  ...
  <li><strong>Re-Entry and Reletting.</strong> Landlord may re-enter the Premises and relet the Premises or any part thereof for the account of Tenant, for such term, at such rental, and upon such other conditions as Landlord deems appropriate. Consistent with Landlord&rsquo;s duty to mitigate damages under Minnesota law, Landlord shall use commercially reasonable efforts to relet the Premises following Tenant&rsquo;s default or surrender. If the proceeds of such reletting, after deduction of all reasonable costs and expenses of reletting (including but not limited to brokerage commissions, tenant improvement costs, advertising costs, and attorneys&rsquo; fees), are insufficient to satisfy Tenant&rsquo;s Rent obligations under this Lease, Tenant shall pay such deficiency to Landlord on demand. Landlord&rsquo;s obligation to mitigate shall not require Landlord to accept a replacement tenant on terms materially less favorable than those of this Lease, to lease space in the Building out of the usual order of leasing, or to lease the Premises to a tenant whose use is not permitted under the Building&rsquo;s other leases.</li>
