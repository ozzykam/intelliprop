...
export default function EditAssignmentPage({ params }: EditAssignmentPageProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.push(`/llcs/${llcId}/assignments/${assignmentId}`);
    } catch {
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-6">
        <Link
          href={`/llcs/${llcId}/assignments/${assignmentId}`}
          ...
          {state.claimType === 'rent_debt' && (
            <div className="space-y-3 p-3 bg-secondary/30 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-sm font-medium mb-1">Tenant Phone (optional)</label>
                  <input
                    type="tel"
                ...
                <div>
                  <label className="block text-sm font-medium mb-1">Tenant Email (optional)</label>
                  <input
                    type="email"
