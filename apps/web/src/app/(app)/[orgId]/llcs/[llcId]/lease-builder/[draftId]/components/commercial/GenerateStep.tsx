...
export default function GenerateStep({ draft, llcId }: StepProps) {
  ...
  const leaseType = draft.commercial?.leaseStructure?.leaseType?.toUpperCase() ?? '';
      ...
      return (
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              href={`/${orgId}/llcs/${llcId}/published-leases/${draft.amendingPublishedLeaseId}`}
    ...
    return (
      <div className="space-y-6">
        ...
        <p className="text-sm text-muted-foreground">
          Review your changes and create an addendum to the existing {leaseType} lease. This will generate an addendum document for signing.
        </p>
    ...
    <div className="space-y-6">
      ...
      {!result ? (
        <div className="space-y-4">
          {draft.published && draft.publishedLeaseId && (
            <div className={`p-4 border rounded-lg ${alreadyAccepted ? 'bg-green-50 border-green-200' : 'bg-blue-50 border-blue-200'}`}>
              ...
              <Link
                href={`/${orgId}/llcs/${llcId}/published-leases/${draft.publishedLeaseId}`}
        ...
        <div className="space-y-4">
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-sm font-medium text-green-800 mb-2">
              Commercial lease package generated successfully!
            </p>
