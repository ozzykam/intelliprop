...
interface PageProps {
  params: Promise<{ orgId: string; llcId: string; propertyId: string; unitId: string }>;
}

export default function UnitDashboardPage({ params }: PageProps) {
  const { orgId, llcId, propertyId, unitId } = use(params);
  ...
  return (
    <div className="space-y-8 max-w-5xl">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <Link
            href={`/${orgId}/llcs/${llcId}/properties/${propertyId}/units`}
        ...
        <Link
          href={`/${orgId}/llcs/${llcId}/properties/${propertyId}/units/${unitId}/edit`}
      ...
      <div className="p-4 border rounded-lg space-y-2">
        ...
        {activeLease && (
          <div className="text-sm flex flex-wrap items-center gap-x-1.5 gap-y-0.5">
            ...
            <Link
              href={`/${orgId}/llcs/${llcId}/leases/${activeLease.id}`}
