...
export default function AssignmentDetailPage({ params }: DetailPageProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const data = await res.json();
      if (data.ok) {
        router.push(`/${orgId}/llcs/${llcId}/assignments`);
      } else {
  ...
  return (
    <div>
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <Link href={`/${orgId}/llcs/${llcId}/assignments`} className="text-sm text-muted-foreground hover:text-foreground mb-2 inline-block">
            ← Assignments
          </Link>
        ...
        <div className="space-y-6">
          ...
          {relatedCase && (
            <div className="p-4 border rounded-lg bg-secondary/20">
              ...
              <Link
                href={`/${orgId}/llcs/${llcId}/legal/${relatedCase.id}`}
            ...
            <dl className="grid grid-cols-2 gap-4 p-4 border rounded-lg">
              ...
              {assignment.tenantId && (
                <div>
                  ...
                  <dd className="text-sm mt-0.5">
                    <Link href={`/${orgId}/llcs/${llcId}/tenants/${assignment.tenantId}`} className="text-primary hover:underline">
                      View Tenant
                    </Link>
                  </dd>
                </div>
              ...
              {assignment.insuranceClaimId && (
                <div>
                  ...
                  <dd className="text-sm mt-0.5">
                    <Link href={`/${orgId}/llcs/${llcId}/insurance/claims/${assignment.insuranceClaimId}`} className="text-primary hover:underline">
          ...
          {assignment.status === 'draft' && (
            <div className="pt-2 border-t flex gap-2">
              <Link
                href={`/${orgId}/llcs/${llcId}/assignments/${assignmentId}/edit`}
