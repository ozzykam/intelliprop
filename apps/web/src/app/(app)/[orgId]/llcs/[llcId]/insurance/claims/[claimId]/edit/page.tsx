...
interface EditStandaloneClaimPageProps {
...
export default function EditStandaloneClaimPage({ params }: EditStandaloneClaimPageProps) {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        {claim && <p className="text-sm text-muted-foreground mt-0.5">{claim.entityName}</p>}
      </div>
