  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <Link href={`/${orgId}/llcs/${llcId}/billing/charges?status=open`} className="p-4 border rounded-lg hover:bg-secondary/30 transition-colors">
      ...
      <div className="flex flex-wrap gap-3 mb-8">
        <Link
          href={`/${orgId}/llcs/${llcId}/billing/charges`}
          className="px-4 py-2 bg-primary text-primary-foreground rounded-md text-sm hover:opacity-90 transition-opacity"
        >
          View All Charges
        </Link>
        <Link
          href={`/${orgId}/llcs/${llcId}/billing/payments`}
          className="px-4 py-2 bg-primary text-primary-foreground rounded-md text-sm hover:opacity-90 transition-opacity"
        >
          View All Payments
        </Link>
        <Link
          href={`/${orgId}/llcs/${llcId}/billing/charges?status=open`}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="border rounded-lg">
          <div className="p-4 border-b flex items-center justify-between">
            ...
            <Link href={`/${orgId}/llcs/${llcId}/billing/charges`} className="text-sm text-primary hover:underline">
              View all
            </Link>
          </div>
              ...
              {stats.recentCharges.map(charge => {
                ...
                return (
                  <div key={charge.id} className="p-4 flex items-center gap-4">
                    ...
                    <Link
                      href={`/${orgId}/llcs/${llcId}/published-leases/${charge.leaseId}`}
        ...
        <div className="border rounded-lg">
          <div className="p-4 border-b flex items-center justify-between">
            ...
            <Link href={`/${orgId}/llcs/${llcId}/billing/payments`} className="text-sm text-primary hover:underline">
              View all
            </Link>
          </div>
            ...
            <div className="divide-y">
              {stats.recentPayments.map(payment => (
                <div key={payment.id} className="p-4 flex items-center gap-4">
                  ...
                  <Link
                    href={`/${orgId}/llcs/${llcId}/leases/${payment.leaseId}`}
                    className="p-1.5 text-muted-foreground hover:text-foreground hover:bg-secondary rounded transition-colors"
                    title="View Lease"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
