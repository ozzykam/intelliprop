  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          href={`/${orgId}/llcs/${llcId}/settings`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <Link href={`/${orgId}/llcs/${llcId}/properties`} className="p-4 border rounded-lg hover:bg-secondary/30 transition-colors">
        ...
        <Link href={`/${orgId}/llcs/${llcId}/leases`} className="p-4 border rounded-lg hover:bg-secondary/30 transition-colors">
        ...
        <Link href={`/${orgId}/llcs/${llcId}/billing`} className="p-4 border rounded-lg hover:bg-secondary/30 transition-colors">
        ...
        <Link href={`/${orgId}/llcs/${llcId}/legal`} className="p-4 border rounded-lg hover:bg-secondary/30 transition-colors">
      ...
      <div className="mt-8">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            href={`/${orgId}/llcs/${llcId}/legal/new`}
            className="px-4 py-2 border rounded-md text-sm hover:bg-secondary transition-colors"
          >
            + New Case
          </Link>
